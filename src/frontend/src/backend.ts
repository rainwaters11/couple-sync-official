...
export class Backend implements backendInterface {
    ...
    async checkRoomSyncStatus(arg0: string): Promise<RoomSyncStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.checkRoomSyncStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRoomSurprises(arg0: string): Promise<RoomSurpriseState> {
        if (this.processError) {
            try {
                const result = await this.actor.getRoomSurprises(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRoleSurprise(arg0: string, arg1: string, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRoleSurprise(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRoomState(arg0: string, arg1: string, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRoomState(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
