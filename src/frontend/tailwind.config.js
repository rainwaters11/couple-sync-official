    ...
    theme: {
        ...
        extend: {
            ...
            boxShadow: {
                ...
                soft: '0 2px 12px -2px rgba(0,0,0,0.08), 0 4px 20px -4px rgba(0,0,0,0.06)',
                glow: '0 0 20px -5px rgba(0,0,0,0.1), 0 8px 32px -8px rgba(0,0,0,0.12)',
                'warm-glow': '0 4px 24px -4px oklch(0.62 0.18 20 / 0.25), 0 8px 40px -8px oklch(0.62 0.18 20 / 0.15)',
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
